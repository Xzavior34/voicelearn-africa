...
__tests__/                 — 109 unit/integration tests (vitest: 109 passed, 0 skipped)
```

## Why this separation

- **Speech vs. tutor**: any speech provider can be swapped without touching tutor logic, and the
  tutor pipeline can be fully tested (and was — 109 passing tests) without ever calling a live
